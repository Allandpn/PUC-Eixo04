...
import { GetInstrumentosUnNaoEmprestadoUseCase } from "../unidade/useCases/getInstrumentosUnidade/getInstNaoEmprestadoUnUseCase";


export class GetInstrumentoLocalidadeNaoEmprestadoController {
    async handle (req: Request, res: Response) {

        const getInstrumentosUnUseCase = new GetInstrumentosUnNaoEmprestadoUseCase();
