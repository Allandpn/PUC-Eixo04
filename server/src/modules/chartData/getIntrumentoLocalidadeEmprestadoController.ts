...
import { GetInstrumentosUnEmprestadoUseCase } from "../unidade/useCases/getInstrumentosUnidade/getInstEmprestadoUnUseCase";



export class GetInstrumentoLocalidadeEmprestadoController {
    async handle (req: Request, res: Response) {

        const getInstrumentosUnUseCase = new GetInstrumentosUnEmprestadoUseCase();
