...
CREATE TABLE "instrumentos" (
    ...
    "isEmprestado" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "cursos" (
    ...
    "instrumentosCursoNome" TEXT,
    CONSTRAINT "cursos_instrumentosCursoNome_fkey" FOREIGN KEY ("instrumentosCursoNome") REFERENCES "tiposdeinstrumentos" ("nomeInstrumento") ON DELETE SET NULL ON UPDATE CASCADE
);
